...
serial devices, remote terminal servers (via the telnet protocol), external
processes (e.g., using Expect to control connections over telnet or ssh),
and IPMI Serial-Over-LAN.
